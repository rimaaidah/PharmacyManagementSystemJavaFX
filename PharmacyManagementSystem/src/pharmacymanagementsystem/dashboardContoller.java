...
//    DATABASE TOOLS
    ...
    public void defaultNav(){
        dashboard_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #ffabd4, #862f5c);");
    }
    ...
    public void switchForm(ActionEvent event){
        ...
        if(event.getSource() == dashboard_btn){
            ...
            addMed_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #ffabd4, #862f5c);");
            ...
            pruchase_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #ffabd4, #862f5c);");
            dashboard_btn.setStyle("-fx-background-color:transparent");
            addMed_btn.setStyle("-fx-background-color:transparent");
